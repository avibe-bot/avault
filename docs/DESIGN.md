...
| · **Phase C** | `file + passphrase` master store (passphrase-wrapped master, unlock once at startup). | done |
...
`avault:blind-box:v1`; HPKE AAD is the UTF-8 bytes of the same scheme identifier.
